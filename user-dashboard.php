...
<html lang="en">
  <head>
    ...
    <!--fonts-->
    <link
      href="https://fonts.googleapis.com/css?family=Montserrat:500,600,900&display=swap"
      rel="stylesheet"
    />
    ...
    <nav class="navbar fixed-top navbar-dark bg-dark">
      <div class="container-fluid">
        <a href="user-dashboard.php" class="navbar-brand logo py-2">BOOKWARM</a>
...
<div class="offcanvas bg-dark sidebar-nav offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
  <div class="offcanvas-header ">
    <div class="user-display">
      <img src="<?php echo isset($user['profileImage']) ? $user['profileImage'] : './assets/profile/beard.png'; ?>" alt="" class="profile-picture" alt="">
      <h4 class="name"> Welcome, <?php echo isset($user['firstName']) ? $user['firstName'] : ''; ?> </h4>
    </div>
  </div>
  ...
  <div class="top-today" id="top-today">
    ...
    <!--first card-->
      ...
      <a href="#" class="btn btn-dark ">Add</a>
      <a href="#" class="btn btn-dark">Review</a>
      <a href="#" id= "read-two" class="btn btn-dark">Read</a>
      </div>
      </div>
      <!--third card-->
        <div class="card my-4" style="width: 18rem;">
      ...
      <a href="#" class="btn btn-dark">Add</a>
      <a href="#" id="review" class="btn btn-dark">Review</a>
      <a href="#" id="read-third" class="btn btn-dark">Read</a>
      </div>
      </div>
    </div>
  </div>
