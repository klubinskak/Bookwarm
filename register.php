                ...
                <div class="d-flex justify-content-center">
                    <form action="register-process.php" method="post" enctype="multipart/form-data" id="reg-form">
                        <div class="form-row">
                            ...
                            <div class="col">
                                <input type="text" value="<?php if(isset($_POST['LastName'])) echo $_POST['LastName'];  ?>" name="last-name" id="LastName" class="form-control" placeholder="Last Name">
                            </div>
                        </div>
                        ...
                        <div class="submit-btn text-center my-5">
                            <button type="submit" onclick="confirmPassword(event)" class="btn btn-dark  rounded-pill text-white px-5" style="height: 50px;">Create account</button>
                        </div>
